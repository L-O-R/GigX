  ...
  return (
    <section className="relative min-h-screen bg-[#0D1CC3] text-white flex flex-col items-center justify-center gap-6">
      <div className="mt-[15vh]">
        <h1 className="text-primary text-center text-[5.5rem] leading-tight mb-20">
          Turning everyday spaces <br /> into brand
          experiences
        </h1>
        <div className="flex max-w-[85%] mx-auto mb-8 pointer-none:">
        ...
        <div className="max-w-lg mx-auto text-center my-14 space-y-4">
          <p className="text-xl font-text font-normal">
            Catch Us Outside creates real experiences, not
            just digital impressions
          </p>
          <button className="cursor-pointer text-black rounded-4xl bg-[#C0DD2B] p-4 font-text text-xl font-normal leading-[100%] -tracking-[0.025rem]">
            Activate Now!
          </button>
        </div>
      </div>
