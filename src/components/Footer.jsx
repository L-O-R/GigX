...
import footerLogoM from "../assets/images/footLogoM.png";
const Footer = () => {
  return (
    <footer>
      ...
      <section className="bg-[#141414] pt-30 -mt-20 ">
        <div className="max-w-[93%] mx-auto flex flex-col space-y-14">
          <div className="flex flex-col lg:flex-row gap-10 justify-between pt-30 lg:pt-10 pb-20 ">
            ...
            <div>
              <ul className="text-2xl text-white font-text leading-normal flex flex-col gap-2 ">
                <li>
                  <a href="">About Us</a>
                </li>
                <li>
          ...
          <div className="space-y-10 flex flex-col">
            ...
            <div>
              <img
                ...
                className="hidden lg:block w-full h-full object-cover border-white"
                loading="lazy"
                width={1200}
                height={400}
              />
